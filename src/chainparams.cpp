...
public:
    CMainParams()
    {
        ...
        // AP, Seeder Test, 22.09.2019 , remove all other nodes. There should be at least DNS Seeder online 

        vSeeds.push_back(CDNSSeedData("munka10.pl", "seeder1.munka10.pl"));
